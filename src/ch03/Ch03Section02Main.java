...
public class Ch03Section02Main {
    public static void main(String[] args) {
        Function<String, Integer> strLength = String::length;
        int length = strLength.apply("hello world");
        System.out.println(length);

        BiPredicate<String, String> strEqulas = String::equals;
        boolean helloEqualsWorld = strEqulas.test("hello", "world");
        System.out.println(helloEqualsWorld);

        System.out.println(strEqulas.test("hello", "hello"));
