...
public class Ch05Section01Optional {
...
//        System.out.println("Same ? : " + userEquals(user1, user2)); //NullPointerException u1.getEmailAddress()가 null이므로

        String someEmail = "some@test.com";
...
//        String email2 = maybeEmail2.get(); //NoSuchElementException: No value present
